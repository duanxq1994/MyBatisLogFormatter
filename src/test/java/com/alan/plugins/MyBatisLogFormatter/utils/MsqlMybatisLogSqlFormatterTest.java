...
public class MsqlMybatisLogSqlFormatterTest {
    ...
    public void testFormatMybatisLog_Date() {
        ...
        String result = SqlUtils.formatMybatisLog(log);
        assertEquals("SELECT * FROM orders WHERE order_date = '2023-12-14 18:03:10'", result);
    }
    ...
    public void testFormatMybatisLog_LocalDateTime() {
        ...
        String result = SqlUtils.formatMybatisLog(log);
        assertEquals("SELECT * FROM orders WHERE update_time = '2023-12-14 18:03:10'", result);
    }
    ...
    public void testFormatMybatisLog_ComplexExample() {
        ...
        String result = SqlUtils.formatMybatisLog(log);
        assertEquals("select count(1) FROM JS_TABLE_TAG o WHERE 1=1 AND o.TABLE_NAME = 'JS_RANGE_DEF' AND o.TAG_NAME = 'Best Area(New)' AND ( 1=1 and (o.MAIN_OBJECT_ID in ( 99559 ,0 ) ) OR DEFAULT_AREA = 1 ) AND o.AREA_TYPE = '01' AND o.updated = true ORDER BY o.UPDATED_TIME DESC", result);
    }
    ...
    public void testFormatMybatisLog_ComplexExample_2() {
        ...
        String result = SqlUtils.formatMybatisLog(log);
        assertEquals("select count(1) FROM JS_TABLE_TAG o WHERE 1=1 AND o.TABLE_NAME = 'JS_RANGE_DEF' AND o.TAG_NAME = 'Best Area(String), (New)' AND ( 1=1 and (o.MAIN_OBJECT_ID in ( 99559 ,0 ) ) OR DEFAULT_AREA = 1 ) AND o.AREA_TYPE = '01' AND o.updated = true ORDER BY o.UPDATED_TIME DESC", result);
    }
    ...
    public void testFormatMybatisLog_EmptyLog() {
        String result = SqlUtils.formatMybatisLog("");
        assertEquals("", result);
    }
