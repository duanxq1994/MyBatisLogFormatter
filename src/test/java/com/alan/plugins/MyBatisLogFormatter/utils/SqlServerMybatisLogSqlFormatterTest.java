...
import static com.alan.plugins.MyBatisLogFormatter.utils.DatabaseType.SQL_SERVER;
import static org.junit.Assert.assertEquals;

import org.junit.Test;

/**
 * SQL Server SQL 格式化器单元测试
 */
public class SqlServerMybatisLogSqlFormatterTest {

    @Test
    public void testFormatMybatisLog_SimpleString() {
        String log = "Preparing: SELECT * FROM users WHERE name = ?\n" +
                "Parameters: John(String)";
        String result = SqlUtils.formatMybatisLog(log, SQL_SERVER);
