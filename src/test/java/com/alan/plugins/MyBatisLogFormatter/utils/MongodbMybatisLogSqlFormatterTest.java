...
import static com.alan.plugins.MyBatisLogFormatter.utils.DatabaseType.MONGODB;
import static org.junit.Assert.assertEquals;

import org.junit.Test;

/**
 * MongoDB SQL 格式化器单元测试
 */
public class MongodbMybatisLogSqlFormatterTest {

    @Test
    public void testFormatMybatisLog_SimpleString() {
        String log = "Preparing: SELECT * FROM users WHERE name = ?\n" +
                "Parameters: John(String)";
        String result = SqlUtils.formatMybatisLog(log, MONGODB);
